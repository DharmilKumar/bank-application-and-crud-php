                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            if ($ab < 0) {
                                ...
                                if ($conn->query($sql) && $conn->query($sql3)) {
                                    echo "<script type='text/javascript'>alert('Amount Withdraw!');window.location='withdraw.php'</script>";
                                }
                            }
                        }
                    }
        ...
        <div class="card mx-auto mt-5" style="width: 30rem;">
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="deposit" class="form-label">Enter WithDraw Amount</label>
